...
# 🔹 لیستی 10 BINەکان (529415 زیاد کرا)
BINS_INFO = [
...
print(f"✅ {len(CARDS_LIST)} کارتی تەواو جیاواز (بە 10 BIN) دروستکران.")
...
async def main():
    ...
    print(f"🚀 بۆت دەستی پێکرد بۆ ناردنی {NUMBER_OF_CARDS} کارت بە 10 BIN و 5 چرکە...")
    while True:
